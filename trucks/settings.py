...
MIN_GALLONS_PER_STOP = float(os.getenv("MIN_GALLONS_PER_STOP", "20"))
...
DETOUR_LIMIT_FALLBACK_MILES = float(os.getenv("DETOUR_LIMIT_FALLBACK_MILES", "30"))
DETOUR_LOW_THRESHOLD_MILES = float(os.getenv("DETOUR_LOW_THRESHOLD_MILES", "6"))

DETOUR_ECON_SPEED_MPH = float(os.getenv("DETOUR_ECON_SPEED_MPH", "50"))
DETOUR_ECON_TIME_COST_PER_HOUR = float(os.getenv("DETOUR_ECON_TIME_COST_PER_HOUR", "55"))
DETOUR_ECON_EXTRA_WEAR_COST_PER_MILE = float(os.getenv("DETOUR_ECON_EXTRA_WEAR_COST_PER_MILE", "0.2"))
DETOUR_MIN_NET_SAVING_DOLLARS = float(os.getenv("DETOUR_MIN_NET_SAVING_DOLLARS", "0"))
CORRIDOR_MAX_DISTANCE_MILES = float(os.getenv("CORRIDOR_MAX_DISTANCE_MILES", "20"))
INITIAL_STOP_RADIUS_MILES = float(os.getenv("INITIAL_STOP_RADIUS_MILES", "10"))
DETOUR_MIN_HOLD_RANGE_MILES = float(os.getenv("DETOUR_MIN_HOLD_RANGE_MILES", "20"))
